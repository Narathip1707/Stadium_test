                ...
                <div class="modal-body">
                    <form id="addFieldForm" enctype="multipart/form-data">
                        <div class="mb-3">
                            ...
                            <div class="invalid-feedback">ประเภทสนามต้องเป็นภาษาอังกฤษเท่านั้น</div>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="imageFile" class="form-label">รูปภาพ (สูงสุด 5MB)</label>
                            <input type="file" class="form-control" id="imageFile" name="imageFile" accept="image/jpeg,image/png,image/webp" required>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editFieldForm" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="editImageFile" class="form-label">รูปภาพ (สูงสุด 5MB, อัพโหลดใหม่ถ้าต้องการเปลี่ยน)</label>
                            <input type="file" class="form-control" id="editImageFile" name="imageFile" accept="image/jpeg,image/png,image/webp">
